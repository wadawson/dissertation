...
This cluster was also observed in the Sunyaev-Zel'dovich Array Survey \citep{Muchovej:2010gc} which provided evidence that the cluster gas is dissociated from the bulk of the mass and galaxies.
...
Furthermore, we find a comparable number distribution of sources as a function of magnitude when we make similar cuts to the HUDF \citep{Coe:2006jf} and GOODS North \& South \citep{Giavalisco:2004kl} galaxy catalogs, indicating negligible cluster contamination.
...
Including a moderate impact parameter of $\sim$0.1$R_{200}$ should have less than a 1\% effect on the merger velocity \citep{Mastropietro:2008fs}.
...
For a consistency check we compare our analytic estimate of the Bullet Cluster's time-since-collision with the numerical model results of \citet{Springel:2007bg} and find agreement within $20\%$ (compare the square and diamond points of Figure \ref{fig4}).
...
Given the collision velocities of the other dissociative mergers \citep{Bradac:2008gw,Markevitch:2005bg,Springel:2007bg,Merten:2011gu} we calculate their times-since-collision using our analytic model and find that DLSCL J0916.2+2951 is probing a merger stage $\gtrsim 2-5$ times further progressed than any other known dissociative merger (Figure \ref{fig4}).  

...
(Dawson, 2013, Volume 772, pp. 131-150). \\
...
% %%% Context
Merging galaxy clusters have become important astrophysical probes providing constraints on the dark matter (DM) self-interaction cross-section \citep[$\sigma_{\rm DM}$;][]{Markevitch:2004dl, Mahdavi:2007ed, Randall:2008hs, Bradac:2008gw, Merten:2011gu, Dawson:2012dl}, and the large-scale matter-antimatter ratio \citep{Steigman:2008dy}.
...
Throughout this chapter I assume $\Omega_{\Lambda}=0.7$, $\Omega_m=0.3$, and $H=70$\,km\,s$^{-1}$\,Mpc$^{-1}$.
...
\begin{figure}
\centering
\includegraphics[height=6.5in]{Chapter3/SFcomparison.png}

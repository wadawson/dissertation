...
They represent the ``main'' and ``bullet'' subclusters as NFW halos with  M$_{200_1} = 1.5\times 10^{15} $\,M\sun, c$_1=1.94$, M$_{200_2} = 1.5\times 10^{14}$\,M\sun, and c$_2=7.12$, respectively.
...
\startdata
M$_{200_1}$	&	$10^{14}$\,M\sun	&	15	&	1.5\tablenotemark{a}	&	1	\\
c$_1$	&		&	7.2	&	\nodata\tablenotemark{b}	&	1	\\
M$_{200_2}$	&	$10^{14}$\,M\sun	&	1.5	&	0.15\tablenotemark{a}	&	1	\\
c$_2$	&		&	2.0	&	\nodata\tablenotemark{b}	&	1	\\
...
\begin{figure}
\includegraphics[scale=1.15]{peakvalues_revB.png}
\caption{
...
Given the M$_{200_1}=15 \times 10^{14}$\,M\sun and temperature T$_{\rm X}=14$\,keV of the ``main'' subcluster \citep{Markevitch:2006wv}, the $t_{\rm sc}=1$\,Gyr.
...
\startdata
M$_{200_1}$	&	$10^{14}$\,M\sun	&	3.2	&	2.3	--	4.3	&	1.6	--	5.5	\\
M$_{200_2}$	&	$10^{14}$\,M\sun	&	1.7	&	1.1	--	2.4	&	0.6	--	3.3	\\

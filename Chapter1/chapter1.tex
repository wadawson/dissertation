...
Some finding that SIDM created central density cores (i.e. flattened density profile) that were too large.
...
Furthermore it seems unlikely that the the constraints will ever improve upon existing SIDM constraints.
